...
def optimize_hyperparameters(
    ...
    storage: str = "sqlite:///experiment_6/optuna_studies/exp6.db",
):
    """
    ...
    os.makedirs(os.path.dirname(storage.split("///")[-1] if "///" in storage else
                os.path.join("experiment_6", "optuna_studies")), exist_ok=True)
    ...
    # Save best params
    best_params_path = "experiment_6/optuna_studies/best_params.json"
