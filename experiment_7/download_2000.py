...
def download_sp500(save_path: str = "experiment_7/data/SP500_daily.csv", years: int = 5):
...
def download_stocks_bulk(symbols: list, save_path: str = "experiment_7/data/stocks_2000_daily.parquet",
...
if __name__ == "__main__":
    ...
    # S&P 500
    sp500 = download_sp500("experiment_7/data/SP500_daily.csv", args.years)
    ...
    if not args.sp500_only:
        ...
        stocks = download_stocks_bulk(
            tickers,
            save_path="experiment_7/data/stocks_2000_daily.parquet",
            years=args.years,
